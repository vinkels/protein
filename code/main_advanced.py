...
def main(protein):
	for i in range(20):
		...
		new_protein = simulated_annealing.anneal(protein_object, 'test%s' %(20+i), 1)
		folder_iter.write_csv(new_protein[2], 'result_anneal%s' %(20+i))
		functions.Visualizer2D(new_protein[1], protein, new_protein[0], 'test%s' %(20+i))
